...
gauge.js
File with JavaScript code for gauge about religion in the Netherlands
*/

function loadGauge(elementId, value, config) {
    ...
    return {
        ...
        colour: "#7bea7b", // The color of the outer circle.
        ...
        colour: "#bdf5bd", // The color of the fill wave.
        ...
        textColour: "#045681", // The color of the value text when the wave does not overlap it.
        wavetextColour: "#4da6ff" // The color of the value text when the wave overlaps it.
    };
}
